...
var Reveal = (function () {
	...
	var VERTICAL_SLIDES_SELECTOR = '.reveal .slides>section.present>section'

	var HOME_SLIDE_SELECTOR = '.reveal .slides>section:first-child'
	...
	var activateOverviewTimeout = 0

	// A delay used to deactivate the overview mode

	var deactivateOverviewTimeout = 0
	...
	return {
		...
		isLastSlide: function () {
			if (currentSlide && currentSlide.classList.contains('.stack')) {
				return currentSlide.querySelector(SLIDES_SELECTOR + '.future') == null
			} else {
				return document.querySelector(SLIDES_SELECTOR + '.future') == null
			}
		},
