...
;(function (root, factory) {
  ...
  function configure (options) {
    ...
    dom.slideNumber.style.display =
      config.slideNumber && !isPrintingPDF() ? 'block' : 'none'
  ...
  function enablePreviewLinks (selector) {
    var anchors = toArray(document.querySelectorAll(selector || 'a'))
  ...
  function layoutSlideContents (width, height, padding) {
    ...
    toArray(dom.slides.querySelectorAll('section > .stretch')).forEach(function (
      ...
      if (/(img|video)/gi.test(element.nodeName)) {
        ...
        var nh = element.naturalHeight || element.videoHeight
  ...
  function layoutOverview () {
    ...
    var slideHeight = config.height + margin
  ...
  function updateSlidesVisibility () {
    ...
    if (horizontalSlidesLength && typeof indexh !== 'undefined') {
      ...
      for (var x = 0; x < horizontalSlidesLength; x++) {
        ...
        var verticalSlidesLength = verticalSlides.length
  ...
  function updateParallax () {
    if (config.parallaxBackgroundImage) {
      ...
      var verticalSlides = dom.wrapper.querySelectorAll(
        VERTICAL_SLIDES_SELECTOR
      )
  ...
  function showSlide (slide) {
    ...
    if (background) {
      ...
      if (background.hasAttribute('data-loaded') === false) {
        ...
        var backgroundVideoLoop = slide.hasAttribute(
  ...
  function availableRoutes () {
    ...
    var verticalSlides = dom.wrapper.querySelectorAll(VERTICAL_SLIDES_SELECTOR)
  ...
  function setState (state) {
    if (typeof state === 'object') {
      ...
      var overviewFlag = deserialize(state.overview)
  ...
  function onTouchMove (event) {
    ...
    if (!touch.captured) {
      ...
      if (
        ...
        var deltaY = currentY - touch.startY
    ...
    if (eventsAreBound && isOverview()) {
      ...
      if (element && !element.classList.contains('disabled')) {
        ...
        if (element.nodeName.match(/section/gi)) {
          ...
          var v = parseInt(element.getAttribute('data-index-v'), 10)
  ...
  Playback.prototype.render = function () {
    ...
    var radius = this.diameter / 2 - this.thickness

    var x = this.diameter / 2

    var y = this.diameter / 2
