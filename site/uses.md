...
This page is proving to be a difficult one to keep updated because I'm constantly tinkering, but here's a snapshot.

## Theme

- [Mono Lisa](https://www.monolisa.dev) is mono-spaced and ligaturized, font for all my dev uses.
...
- These days I'm using [Ghostty](https://ghostty.org) for it's speed.
...
- [Alfred App](https://www.alfredapp.com) handles my launching, text conversion, and clipboard history (along with other goodness).
